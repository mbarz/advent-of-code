import { getAllMagnitudes, sumOfSnailfishs } from './snailfish';
...
console.time('Part 1');
const part1 = sumOfSnailfishs(input).magnitude();
console.timeEnd('Part 1');
console.log(part1);

console.time('Part 2');
const magnitudes = getAllMagnitudes(input);
const part2 = Math.max(...magnitudes);
